...
const AuthenticatedSettingsBrandLazyImport = createFileRoute(
...
const authSellerRoute = authSellerImport.update({
  id: '/(auth)/seller',
  path: '/seller',
  getParentRoute: () => rootRoute,
} as any)
...
const AuthenticatedSettingsBrandLazyRoute =
  AuthenticatedSettingsBrandLazyImport.update({
    id: '/brand',
    path: '/brand',
    getParentRoute: () => AuthenticatedSettingsRouteLazyRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/settings/brand.lazy').then((d) => d.Route),
  )
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/(auth)/seller': {
      ...
      path: '/seller'
      fullPath: '/seller'
      preLoaderRoute: typeof authSellerImport
      parentRoute: typeof rootRoute
    }
    '/(auth)/sign-in': {
      id: '/(auth)/sign-in'
    ...
    '/_authenticated/settings/brand': {
      ...
      preLoaderRoute: typeof AuthenticatedSettingsBrandLazyImport
      parentRoute: typeof AuthenticatedSettingsRouteLazyImport
    }
    '/_authenticated/settings/display': {
...
const AuthenticatedSettingsRouteLazyRouteChildren: AuthenticatedSettingsRouteLazyRouteChildren =
  {
    AuthenticatedSettingsAppearanceLazyRoute:
      AuthenticatedSettingsAppearanceLazyRoute,
    AuthenticatedSettingsBrandLazyRoute: AuthenticatedSettingsBrandLazyRoute,
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/settings/brand": {
      "filePath": "_authenticated/settings/brand.lazy.tsx",
      "parent": "/_authenticated/settings"
    },
    "/_authenticated/settings/display": {
